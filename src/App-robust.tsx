...
try {
  LiveTranscription =
    require("../components/LiveTranscription").LiveTranscription;
} catch (e) {
  console.warn("LiveTranscription component failed to load:", e);
  LiveTranscription = () => (
    <div style={{ color: "white", padding: "2rem" }}>
      LiveTranscription component failed to load
    </div>
  );
}
...
try {
  ...
  Settings = () => (
    <div style={{ color: "white", padding: "2rem" }}>
      Settings component failed to load
    </div>
  );
}
...
try {
  ...
  PastSessions = () => (
    <div style={{ color: "white", padding: "2rem" }}>
      PastSessions component failed to load
    </div>
  );
}
...
try {
  ...
  SessionDetail = () => (
    <div style={{ color: "white", padding: "2rem" }}>
      SessionDetail component failed to load
    </div>
  );
}
      ...
      return (
        ...
        >
          ...
          <p style={{ marginBottom: "2rem" }}>
            Something went wrong while loading the {currentPage} page.
          </p>
          <button
          ...
          >
            ...
            <pre style={{ color: "#EF4444", fontSize: "0.9rem" }}>
              {String(error)}
            </pre>
          </div>
        </div>
