...
// Simple test component for Live Transcription
function SimpleLiveTranscription({ onNavigate }: { onNavigate: any }) {
  return (
    <div style={{ 
      minHeight: '100vh', 
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '2rem', fontWeight: 'bold' }}>🎙️ Live Transcription</h1>
          <div></div>
        </div>
...
// Simple test component for Sessions
    ...
    <div style={{ 
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '2rem', fontWeight: 'bold' }}>📋 Past Sessions</h1>
          <div></div>
        </div>
        ...
        <div style={{ 
          ...
          <h3 style={{ fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '1rem' }}>Recent Sessions</h3>
    ...
    <div style={{ 
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ 
          ...
          <h3 style={{ fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '1rem' }}>Azure Configuration</h3>
          <div style={{ color: '#94A3B8' }}>
            <p>Configure your Azure Speech Services and OpenAI settings here.</p>
          </div>
        </div>
      </div>
    </div>
...
function App() {
  ...
  const renderCurrentPage = () => {
    switch (currentPage) {
      case "dashboard":
        return <SimpleDashboard onNavigate={navigate} />;
      case "live":
        return <SimpleLiveTranscription onNavigate={navigate} />;
      case "settings":
        return <SimpleSettingsPage onNavigate={navigate} />;
      case "sessions":
