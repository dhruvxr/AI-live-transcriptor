...
export function SimpleLiveTranscription({ onNavigate }: LiveTranscriptionProps) {
  ...
  const handleStartSession = () => {
    ...
    setTimeout(() => {
      setTranscript(prev => [...prev, {
        id: '2',
        content: 'This is a simplified version of the live transcription component.',
        timestamp: new Date(),
        speaker: 'Demo'
      }]);
    }, 3000);
    ...
    setTimeout(() => {
      setTranscript(prev => [...prev, {
        id: '3',
        content: 'To enable full functionality, configure your Azure Speech Services in Settings.',
        timestamp: new Date(),
        speaker: 'Demo'
      }]);
    }, 5000);
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#0F172A', color: 'white', display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <span style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>🎙️ AI Transcriptor</span>
            <span style={{ 
              backgroundColor: '#10B981', 
              color: 'white', 
      ...
      <div style={{ flex: 1, overflow: 'hidden' }}>
        <div ref={scrollRef} style={{ height: '100%', overflowY: 'auto', padding: '1rem' }}>
      ...
      <footer style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem' }}>
          ...
          <button
            onClick={() => {
              const data = transcript.map(item => 
                `[${formatTime(item.timestamp)}] ${item.speaker}: ${item.content}`
              ).join('\n');
